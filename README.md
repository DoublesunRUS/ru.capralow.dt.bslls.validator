...
Текущий релиз в ветке [master: 0.5.1](https://github.com/DoublesunRUS/ru.capralow.dt.bslls.validator/tree/master).<br>
...
Игнорируются проверки с типом CODE_SMELL.INFO. 